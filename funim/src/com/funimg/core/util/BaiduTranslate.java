...
public class BaiduTranslate {
	...
	public static String translate(String source) {
		...
		// 组装查询地址
		String requestUrl = "http://openapi.baidu.com/public/2.0/bmt/translate?client_id=CEPgQbctbox2EeTjn2Dzly1B&q={keyWord}&from=auto&to=auto";
...
//			dst = translateResult.getTrans_result().get(0).getDst();
	...
	public static void main(String[] args) {
		...
		String res = translate("好好学习，天天向上");
