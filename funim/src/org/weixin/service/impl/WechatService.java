...
import com.funimg.web.util.BaiduApis;
...
public class WechatService {
	...
	public String coreService(HttpServletRequest request) {
		...
		try {
			...
			wxMessage.setCreateTime(createTime);
			...
			// 视频消息
				...
				//
				wxMessage.setMediaId(MediaId);
				wxMessage.setThumbMediaId(ThumbMediaId);
				wxMessageDao.save(wxMessage);
			...
			// 地理位置消息
				...
				//
				wxMessage.setLocationX(Location_X);
				wxMessage.setLocationY(Location_Y);
				wxMessage.setScale(Scale);
				wxMessage.setLabel(Label);
				wxMessageDao.save(wxMessage);
			...
			// 链接消息
				...
				wxMessage.setDescription(Description);
