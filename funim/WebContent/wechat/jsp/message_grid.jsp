...
$(function(){ 
	$("#list").jqGrid({
        url:"${webroot }/wxmsg/getWxMessageList",
        ...
        colModel:[
            ...
            {name:'accountId',index:'accountId', width:'5%',align:'center'},
            {name:'fromUserName',index:'fromUserName', width:'5%',align:'center'},
            {name:'toUserName',index:'toUserName', width:'5%', align:"center"},
            {name:'createTime',index:'createTime', width:'5%', align:"left"},
            {name:'msgType',index:'msgType', width:'5%',align:"center"},
            {name:'msgId',index:'msgId', width:'5%',align:"center", sortable:false},
            {name:'content',index:'content', width:'10%',align:"center"},
            {name:'picUrl',index:'picUrl', width:'10%',align:"center"},
            {name:'mediaId',index:'mediaId', width:'5%',align:"center"},
            {name:'format',index:'format', width:'5%',align:"center"},
            {name:'thumbMediaId',index:'thumbMediaId', width:'5%',align:"center"},
            {name:'locationX',index:'locationX', width:'5%',align:"center"},
            {name:'locationY',index:'locationY', width:'5%',align:"center"},
            {name:'scale',index:'scale', width:'5%',align:"center"},
            {name:'label',index:'label', width:'5%',align:"center"},
            {name:'title',index:'title', width:'5%',align:"center"},
            {name:'description',index:'description', width:'5%',align:"center"},
            {name:'url',index:'url', width:'5%',align:"center"}
        ],
